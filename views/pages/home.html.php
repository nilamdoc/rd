<?php
?>
<div id="back" style="height:800px;border:1px solid gray;
			background-image: url('img/LEAD/background.jpg'); background-position: center; background-repeat: no-repeat; background-size: cover">
	<div><br><br><br><br><br>
		<img src="img/LEAD/Bethepart.gif" style="display: block;
  margin-left: auto;
  margin-right: auto;
  width: 50%;"><br><br>
		<img src="img/LEAD/Transform.gif" style="display: block;
  margin-left: auto;
  margin-right: auto;
