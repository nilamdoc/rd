...
table {
  ...
  <div class="block block-strong inset elevation-20" style="border:3px solid gray" id="AnswerA" onclick="showSelected()"  onmouseover="" name="AnswerA">
	...
	<table width="col:100%">
		<tr>
			<td col="20px"><input type="radio" name="Question" id="QuestionA" ><i class="icon-radio"></i></td>
  ...
  <table>
		<tr>
			<td col="20px"><input type="radio" name="Question" id="QuestionB"><i class="icon-radio"></i></td>
